...
public class Client implements ActionListener{
	...
	Client(){
		...
		ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("image/champakji.png"));
		Image i5 = i4.getImage().getScaledInstance(40,45,Image.SCALE_DEFAULT);
		ImageIcon i6= new ImageIcon(i5);
		JLabel pic1 = new JLabel(i6);
		pic1.setBounds(40,10,50,50);
		jp.add(pic1);
		...
		JLabel name  = new JLabel("Champak Lal");
	...
	public static JPanel formatLabel(String out) {
		...
		output.setBackground(new Color(140, 143, 230));
